...
urlpatterns = [
    ...
    path("job/quick_job_note", constructors.quick_job_note, name="quick_job_note"),
    #job files
    path("job/quick_job_file", constructors.quick_job_file, name="quick_job_file"),
    #job crew members
    path("job/quick_fsr_add", constructors.quick_fsr_add, name="quick_fsr_add"),
    #job site notes
    ...
    path("session_request", constructors.session_request, name="session_request"),
    path("session_accept_toggle", constructors.session_accept_toggle, name="session_accept_toggle"),
    path("session_decline_toggle", constructors.session_decline_toggle, name="session_decline_toggle"),
    path("issue_resolved_toggle", constructors.issue_resolved_toggle, name="issue_resolved_toggle"),
